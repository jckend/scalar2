...
<p>Press any key to begin.</p>
  ...
  const test_stimuli: Record<string, string>[] = [
    { stimulus1: 'Cleo throws 10 marbles into a swimming pool.',  prompt1: '<p>How likely is it that all the marbles sank?</p>', stimulus2: '<p>Cleo throws 10 marbles into a swimming pool. Her friend tells you: Some of the marbles sank.</p>'},
    { stimulus1: 'Cleo throws 10 marbles into a sandbox.', prompt1: '<p>How likely is it that all the marbles sank?</p>', stimulus2: '<p>Cleo throws 10 marbles into a sandbox. Her friend tells you: Some of the marbles sank.</p>'},
    { stimulus1: 'Troy threw 5 wine glasses off the Empire State Building.', prompt1: '<p>How likely is it that all the glasses broke?</p>', stimulus2: '<p>Troy threw 5 wine glasses off the Empire State Building. His friend tells you: Most of the glasses broke.</p>'},
    { stimulus1: 'Troy dropped 5 wine glasses at the party.', prompt1: '<p>How likely is it that all the glasses broke?</p>', stimulus2: '<p>Troy dropped 5 wine glasses at the party. His friend tells you: Most of the glasses broke.</p>'},
    { stimulus1: 'Noah has missed class so often that he’s been declared truant.', prompt1: '<p>How likely is it that he came to class everyday this month?</p>', stimulus2: '<p>Noah has missed class so often that he’s been declared truant. His friend tells you: Noah sometimes comes to class.</p>'},
    { stimulus1: 'Noah won an award for having the best attendance in his school', prompt1: '<p>How likely is it that he came to class everyday this month?</p>', stimulus2: '<p>Noah won an award for having the best attendance in his school. His friend tells you: Noah sometimes comes to class.</p>'},
    { stimulus1: 'Jamie is very disorganized and frequently oversleeps.', prompt1: '<p>How likely is it that she will be on time to an appointment?</p>', stimulus2: '<p>Jamie is very disorganized and frequently oversleeps. Her friend tells you: Jamie is occasionally on time.</p>'},
    { stimulus1: 'Jamie is very organized and punctual.', prompt1: '<p>How likely is it that she will be on time to an appointment?</p>', stimulus2: '<p>Jamie is very organized and punctual. Her friend tells you: Jamie is occasionally on time.</p>'},
    { stimulus1: 'Joe thrusts his hand into a pot of boiling water.', prompt1: '<p>How likely is it that the water is scalding?</p>', stimulus2: '<p>Joe thrusts his hand into a pot of boiling water. His friend tells you: The water is warm.</p>'},
    { stimulus1: 'Joe thrusts his hand into a bowl of steaming soup.', prompt1: '<p>How likely is it that the soup is scalding?</p>', stimulus2: '<p>Joe thrusts his hand into a bowl of steaming soup. His friend tells you: The soup is warm.</p>'},
    { stimulus1: 'Alice got a shirt from a clothing giveaway.', prompt1: '<p>How likely is it that the shirt was free?</p>', stimulus2: '<p>Alice got a shirt from a clothing giveaway. Her friend tells you: The shirt was cheap.</p>'},
    { stimulus1: 'Alice got a shirt from a clothing store.', prompt1: '<p>How likely is it that the shirt was free?</p>', stimulus2: '<p>Alice got a shirt from a clothing store. Her friend tells you: The shirt was cheap.</p>'},
    { stimulus1: 'James ate at a restaurant with two stars on Yelp.', prompt1: '<p>How likely is it that the food was good?</p>', stimulus2: '<p>James ate a restaurant with five stars on Yelp. His friend tells you: The food was palatable.</p>'},
    { stimulus1: 'James ate at a restaurant with five stars on Yelp.', prompt1: '<p>How likely is it that the food was good?</p>', stimulus2: '<p>James ate a restaurant with five stars on Yelp. His friend tells you: The food was palatable.</p>'},
    { stimulus1: 'Claire is struggling in calculus.', prompt1: '<p>How likely is it that Claire did really well on her midterm?</p>', stimulus2: '<p>Claire is struggling in calculus. Her friend tells you: She got an okay grade on the midterm.</p>'},
    { stimulus1: 'Claire is excelling in calculus.', prompt1: '<p>How likely is it that Claire did really well on her midterm?</p>', stimulus2: '<p>Claire is excelling in calculus. Her friend tells you: She got an okay grade on the midterm.</p>'},
