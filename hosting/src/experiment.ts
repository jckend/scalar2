...
<p>Press any key to begin.</p>
  ...
  const test_stimuli: Record<string, string, array>[] = [
    ...
    { stimulus1: '<p>Alice got a shirt from a clothing giveaway.</p>', stimulus2: '<p>Alice got a shirt from a clothing giveaway. She tells you: The shirt was cheap.</p>', prompt1: '<p>How likely is it that the shirt was free?</p>', prompt2: '<p>How much did the shirt cost?</p>', likert_scale: ["nothing", "not alot", "alot"]},
    { stimulus1: '<p>Alice got a shirt from a clothing store.</p>', stimulus2: '<p>Alice got a shirt from a clothing store. She tells you: The shirt was cheap.</p>', prompt1: '<p>How likely is it that the shirt was free?</p>', prompt2: '<p>How much did the shirt cost?</p>', likert_scale: ["nothing", "not alot", "alot"]},
  ]
